  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="py-20 bg-blue-950 text-white">
        <div className="container px-4 mx-auto max-w-5xl">
          <div className="text-center mb-14">
            <p className="text-yellow-400 font-semibold uppercase tracking-widest text-xs mb-3">Simple, Fair Pricing</p>
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">
              Only Pay for Your Learners
            </h2>
            <p className="text-blue-300 max-w-xl mx-auto text-base leading-relaxed">
              No per-teacher charges. No per-admin fees. School staff access is completely free — you only pay for the students on your roll.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-white/10 border border-white/20 rounded-2xl p-8 text-center hover:bg-white/15 transition">
              ...
              <button onClick={() => window.location.href='/contact'} className="w-full py-3 font-bold text-blue-950 bg-yellow-400 rounded-xl hover:bg-yellow-300 transition text-sm">
                Get Started
              </button>
            </div>
            {/* Growth — highlighted */}
            <div className="relative bg-yellow-400 text-blue-950 rounded-2xl p-8 text-center shadow-2xl scale-105">
              ...
              <button onClick={() => window.location.href='/contact'} className="w-full py-3 font-bold text-white bg-blue-950 rounded-xl hover:bg-blue-900 transition text-sm">
                Get Started
              </button>
            </div>
            {/* Enterprise */}
