...
import { formatDate, formatDateLong, formatDateTime, formatTime } from "../../utils/dateFormat";
    ...
    printWindow.document.write(`
      ...
      <body>
        ...
        <div class="footer">
          ...
          <p>Generated by MySchoolHub &bull; ${formatDateTime(new Date().toISOString())}</p>
        </div>
      </body>
      </html>
    `);
      ...
      <body>
        <div class="header">
          ...
          <div class="receipt-label">
            ...
            <p>Date: ${formatDateLong(now.toISOString())}</p>
            <p>Time: ${formatTime(now.toISOString())}</p>
          </div>
        </div>
        ...
        <div class="footer">
          <p>Thank you for your payment</p>
          <p>Generated by MySchoolHub &bull; ${formatDateTime(now.toISOString())}</p>
        </div>
      </body>
      </html>
    `);
