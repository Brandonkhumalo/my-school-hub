...
import { formatDateFull, formatDateShort, formatDateTime } from "../../utils/dateFormat";
...
export default function AdminExtras() {
  ...
  const handlePrintReport = () => {
    ...
    const formattedDate = formatDateFull(dailyReport.date + 'T00:00:00');
    ...
    printWindow.document.write(`
      ...
      <body>
        ...
        <div class="footer">Generated by MySchoolHub &bull; Printed on ${formatDateTime(new Date().toISOString())}</div>
      </body>
      </html>
    `);
