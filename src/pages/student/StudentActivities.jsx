          ...
          {activeTab === "activities" && (
            activities.length === 0 ? (
              <div className="text-center py-10">
                ...
                <p className="text-gray-400 text-sm">Ask your school admin to enrol you.</p>
              </div>
            ) : (
