...
const ALL_MENU_ITEMS = {
  admin: [
    ...
    { section: "ACADEMICS", items: [
      ...
      { path: "/admin/at-risk-students", icon: "fa-exclamation-triangle", title: "Performance Analysis" },
    ]},
  ...
  teacher: [
    { section: null, items: [
      ...
      { path: "/teacher/performance",  icon: "fa-chart-line",       title: "Performance Analysis" },
      ...
      { path: "/teacher/generate-tests", icon: "fa-magic",          title: "Generate Tests" },
      { path: "/teacher/test-results", icon: "fa-clipboard-check",  title: "Test Results" },
      { path: "/teacher/conferences",  icon: "fa-calendar-check",   title: "Consultation" },
  ...
  student: [
    { section: null, items: [
      ...
      { path: "/student/assignments",   icon: "fa-tasks",              title: "Assignments" },
      { path: "/student/past-papers",   icon: "fa-file-pdf",           title: "Past Exam Papers" },
      { path: "/student/tests",         icon: "fa-clipboard-list",      title: "Tests" },
  ...
  parent: [
    { section: null, items: [
      ...
      { path: "/parent/conferences", icon: "fa-calendar-check", title: "Consultation" },
  ...
  hr: [
    ...
    { section: "ACADEMICS", items: [
      ...
      { path: "/hr/at-risk-students", icon: "fa-exclamation-triangle", title: "Performance Analysis" },
