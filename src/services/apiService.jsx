...
const apiService = {
  ...
  getEventSquad: (eventId) => request(`/academics/activities/events/${eventId}/squad/`, "GET"),
  updateMatchSquad: (eventId, data) => request(`/academics/activities/events/${eventId}/squad/`, "PATCH", data),
  logTrainingAttendance: (eventId, data) => request(`/academics/activities/events/${eventId}/attendance/`, "POST", data),
