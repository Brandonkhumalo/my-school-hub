...
urlpatterns = [
    ...
    path('users/<int:user_id>/unlock-login/', views.unlock_user_login_view, name='unlock-user-login'),
    ...
    path('school/available-pages/', views.available_pages_view, name='school-available-pages'),
    ...
    path('superadmin/schools/<int:school_id>/detail/', superadmin_views.school_detail_panel, name='superadmin-school-detail'),
    ...
    path('superadmin/audit-logs/', superadmin_views.superadmin_audit_logs, name='superadmin-audit-logs'),
    path('superadmin/audit-logs/export/', superadmin_views.superadmin_audit_logs_export, name='superadmin-audit-logs-export'),
